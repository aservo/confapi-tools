...
class ConfluenceTestImport(unittest.TestCase):
    ...
    def delete_spaces(self, list_of_keys):
        for key in list_of_keys:
            ...
            response_delete = requests.delete(url, auth=(CONFLUENCE_USERS["admin_user"]["username"], CONFLUENCE_USERS["admin_user"]["password"]))
            ...
            response_status = requests.get(url_status, auth=(CONFLUENCE_USERS["admin_user"]["username"], CONFLUENCE_USERS["admin_user"]["password"]))
